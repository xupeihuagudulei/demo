...
/**
 * Flink的EndToEnd_Exactly_Once
 * 需求:
 * kafka主题flink-kafka1 --->Flink Source --> Flink-Transformation 做WordCount-->结果存储到kafka主题-flink-kafka2
 * <p>
 * Source Transformation Sink 某一个部分保证Exactly Once，只能叫Exactly Once，如果3个地方都能保证，才叫EndToEnd Exactly Once
 *
 * @Author: jsy
...
public class Flink_Kafka_EndToEnd_Exactly_Once {
    public static void main(String[] args) throws Exception {
        ...
        kafkaSource.setCommitOffsetsOnCheckpoints(true);// TODO 默认就是true//在做Checkpoint的时候提交offset到Checkpoint(为容错)和默认主题(为了外部工具获取)中
        ...
        FlinkKafkaProducer<String> kafkaSink = new FlinkKafkaProducer<>(
                ...
                new KeyedSerializationSchemaWrapper(new SimpleStringSchema()),    // serialization schema 不使用这个序列化会报错，后续使用自定义序列化规则
