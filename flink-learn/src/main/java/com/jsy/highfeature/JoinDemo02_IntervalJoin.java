...
/**
 * Flink双流Join-IntervalJoin
 * 没有窗口，按照对应位置范围（上界和下界）进行join，join右边的是个范围
 * <p>
 * interval join需要设置流A去关联哪个时间范围的流B中的元素。
 * 此处，我设置的下界为-1、上界为0，且上界是一个开区间。表达的意思就是流A中某个元素的时间，对应上一秒的流B中的元素。
 * <p>
