...
public class StreamingWriteHive {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<UserInfo> dataStream = bsEnv
        ...
        // tEnv.createTemporaryView("users", dataStream);
        String insertSql =
                "insert into fs_table SELECT userId, amount, " +
                        " DATE_FORMAT(ts, 'yyyy-MM-dd'), DATE_FORMAT(ts, 'HH'), DATE_FORMAT(ts, 'mm') FROM `myhive`.`default`.`users`";
