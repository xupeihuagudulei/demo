...
/**
 * Flink-DataStream-API-实现WordCount
 *
 * 1、现在node1机器上执行   nc -lk 9999
 * 2、启服务
 * 3、发消息
 *
 * @Author: jsy
 ...
 * 结果前面是线程编号
 */
public class WordCount3DataStreamSocket {
    public static void main(String[] args) throws Exception {
        ...
        env.setRuntimeMode(RuntimeExecutionMode.AUTOMATIC);//注意:使用DataStream根据数据源自动选择使用流还是批，看是否有界
